...
export const users = pgTable("users", {
  ...
  paymentAcceptsUpi: boolean("payment_accepts_upi").default(false).notNull(),
  paymentAcceptsCard: boolean("payment_accepts_card").default(false).notNull(),
  paymentAcceptsCash: boolean("payment_accepts_cash").default(false).notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
